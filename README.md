...
**Goal:** Enter Kaggle competition with Sunny, an app designed to use MedGemma-1.5 to help with skin tracking for possible prevention of skin cancer (prevention is the best cure).
